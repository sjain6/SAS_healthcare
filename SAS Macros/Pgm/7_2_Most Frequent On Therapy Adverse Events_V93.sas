...
/*--Define the template--*/
proc template;
  define statgraph Fig_7_2_Most_Frequent_On_Therapy_Adverse_Events;
    begingraph;
...
/*--Render the graph--*/
ods graphics / reset width=5in height=2.5in imagename='7_2_Most_Frequent_On_Therapy_Adverse_Events_V93';
proc sgrender data=ae2 template=Fig_7_2_Most_Frequent_On_Therapy_Adverse_Events;
  run;
