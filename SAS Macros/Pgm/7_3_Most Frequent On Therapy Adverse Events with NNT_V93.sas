...
/*--Template--*/
proc template;
   define statgraph Fig_7_3_Most_Frequent_On_Therapy_Adverse_Events_NNT;
   begingraph;
      ...
      layout lattice / columns=3 columnweights=(0.3 0.5 0.2) rowdatarange=union columngutter=10px;
        rowaxes;
        ...
        endlayout;
            ...
            /* Right cell with Risk and CI values */
        layout overlay / xaxisopts=(display=(tickvalues) tickvalueattrs=(size=7));
          scatterplot y=aedecod x=xinset /xaxis=x  markercharacter=riskci markercharacterattrs=(size=7);
        endlayout;
...
/*--Plot the graph--*/
ods graphics on / reset width=5in height=2.5in imagename='7_3_Most_Frequent_On_Therapy_Adverse_Events_V93';
proc sgrender data=final template=Fig_7_3_Most_Frequent_On_Therapy_Adverse_Events_NNT;
run;
